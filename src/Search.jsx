    ...
    if (this.state.searched && !this.state.error) {
      return (
        <>
          ...
          <div id="gallery" className="animate">
            <NftGallery ownerAddress="0xf9Cb5a793dA8960619147f8ed9bcEfA278A6E6a6" />
          </div>
        </>
      );
    }
      ...
      return (
        <>
          <p className="description">
            Developed by{" "}
            <a href="https://hereiskunalverma.github.io/tlrc/index.html">
              {" "}
              Kunal Verma{" "}
            </a>
          </p>
        ...
        <form className="search-form" onSubmit={this.handleSubmit}>
          <div className="search-wrapper">
            <ul className="search-header">
              ...
              <li className="search-desc">
                <h2>
                  Sail the blockchain for other users NFT collections by
                  searching their Unstoppable Domains address
                </h2>
              </li>
            </ul>
